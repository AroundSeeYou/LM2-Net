...
def img_create(data, image='/home/cab/lzh/HFANet/misc/111.png'):
...
def visualize_tensors(*tensors, img11):
    """
    ...
    if nums>1:
        ...
        # cv2.imwrite("img/test" + str(img11) + ".png", image)
        # plt.savefig("img/test" + str(img11) + ".png",
        #             bbox_inches="tight",
        #             pad_inches=1,
        #             transparent=True,
        #             facecolor="g",
